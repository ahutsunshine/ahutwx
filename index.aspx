<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Senparc.Weixin.MP.Sample.WebForms.index" %>
	...
	<div id="content">
        ...
        <div class="section" id="services">
            ...
            <div class="half right">
                ...
                <br />
                 <h2>关注微信</h2>
                <ul class="list_bullet">
                    <li>您可以使用微信查找公众账号ahutjw或扫一扫下面的二维码关注我们</li>
                    <div class="img_border img_fl">
        ...
        <div class="section" id="portfolio">
            ...
            <ul id="gallery">
                ...
                <li><a href="images/portfolio/10-l.png" class="no_margin_right" rel="lightbox[portfolio]"><img src="images/portfolio/01.png" alt="图片 10" /></a></li>
            </ul>
            <a href="#home" class="home_btn">主页</a>
